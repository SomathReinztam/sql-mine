import os
import pickle
from graphs.make_querys_without_parser_agent import make_querys_without_parser_agent
...
response = make_querys_without_parser_agent.invoke(initila_state)

querys = response["querys"]
print("---"*5 + "querys")
print(querys)

path_file = r"C:\Users\Acer\Documents\dev\mine-sql\.db_docs\sql-miner"
file = "queries.txt"
...
# deep_queries_processes_agent.py